 ...
 *
 * React locale context lives in `i18n.tsx`.
 *
 * English-key message catalog. Accepts an explicit locale because a public
 * baby page can override the visitor's cookie without changing preference.
 */
const enGB = {
  "(you)": "(you)",
