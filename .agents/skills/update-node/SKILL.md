...
| [`projects/isbabyoutyet/backend/convex.json`](../../../projects/isbabyoutyet/backend/convex.json) `node.nodeVersion` | The major (Convex `"use node"` actions). |
...
There is no Node pin in [`projects/isbabyoutyet/web/vercel.json`](../../../projects/isbabyoutyet/web/vercel.json).
